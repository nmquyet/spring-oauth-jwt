...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
     ...
     *
     * @param oauthServer Security configurer
     * @throws Exception when has exception
     */
    @Override
     ...
     *
     * @param endpoints Server endpoints configurer
     * @throws Exception when has exception
     */
    @Override
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory()
                ...
                // TODO refactor this to separated class
